...
11180 rows × 22 columns
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      const buttonEl =
        document.querySelector('#df-3dfa4323-9492-4134-91fa-423f17a40896 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-3dfa4323-9492-4134-91fa-423f17a40896');
        const dataTable =
...
7453 rows × 21 columns
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      const buttonEl =
        document.querySelector('#df-c72d9e61-6be5-4471-be8a-c485f0fa0805 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-c72d9e61-6be5-4471-be8a-c485f0fa0805');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
